defmodule PhoenixPaasWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixPaasWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixPaasWeb.Gettext, "errors", msg, opts)
    end
  end
