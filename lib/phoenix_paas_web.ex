defmodule PhoenixPaasWeb do
  ...
  def controller do
    quote do
      ...
      use Gettext, backend: PhoenixPaasWeb.Gettext
  ...
  defp html_helpers do
    quote do
      ...
      import Phoenix.HTML
      # Core UI components
      import PhoenixPaasWeb.CoreComponents
      import PhoenixPaasWeb.PaasComponents
  ...
  def verified_routes do
    quote do
      use Phoenix.VerifiedRoutes,
        ...
        router: PhoenixPaasWeb.Router,
        statics: PhoenixPaasWeb.static_paths()
    end
  end
